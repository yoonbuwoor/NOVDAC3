...
class _AccountDeletionCard extends StatelessWidget {
  ...
  static const String _privacyAndDeletionUrl =
      'https://novateur.netlify.app/CONFIDENTIALITE.html';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 5),
                      Text(
                        'Accède aux règles de confidentialité et aux informations permettant de demander la suppression de ton compte et de tes données.',
                        style: TextStyle(
            ...
            const Text(
              'Le lien ci-dessous ouvre la page officielle de confidentialité de Drone Atlas Academy. Tu y trouveras les informations sur les données utilisées et la procédure de suppression du compte.',
